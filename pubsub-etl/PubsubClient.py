...
class PubsubClient(object):
    ...
    def create_topic(self, topic_name):
        ...
        topic = self.get_client().projects().topics().create(
                name='projects/' + self.project + '/topics/' + topic_name, body={}).
    ...
    def create_subscription(self, topic_name, subscription_name, push_endpoint=None):
        ...
        body = {'topic': 'projects/' + self.project + '/topics/' + topic_name}
        ...
        subscription = self.get_client().projects().subscriptions().create(
                    name='projects/' + self.project + '/subscriptions/' + subscription_name,
    ...
    def iter_subscriptions(self):
        ...
        while True:
            resp = self.get_client().projects().subscriptions().list(
                project='projects/' + self.project,
                pageToken=next_page_token).execute(num_entries=self.num_entries)
